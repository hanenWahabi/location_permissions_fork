...
public class LocationPermissionsPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "location_permissions");
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        switch (call.method) {
            case "checkPermission":
                ...
                result.success("Permission check not implemented");
                break;
            case "requestPermission":
                // Implement permission request logic here
                result.success("Permission request not implemented");
                break;
            default:
                result.notImplemented();
        }
